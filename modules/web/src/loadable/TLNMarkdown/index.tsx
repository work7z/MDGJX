...
export default () => {
    ...
    return <CommonTLNBody
        ...
        realtime
        extraOptionsJSX={
            <div className="mt-3"><Pill color="purple">React</Pill></div>
        }
        example={
            `# 潮州历史文化简介

潮州，位于广东省东部，是一座历史悠久的文化名城。自秦始皇时期始，潮州便载入史册，历经沧桑，至今已有两千多年的历史。潮州拥有丰富的文物资源，如古城墙、古寺庙、古府第、古民居、古牌坊等。现有文物景点728处，其中国家重点文物保护单位8处，省级重点文物保护单位11处。
...
潮州曾相继为郡、州、路、府治所，是粤东地区的政治、经济、文化中心。
`
