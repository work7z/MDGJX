...
import GAttachAddon from "./GAttachAddon";
...
class TerminalWrapper extends React.PureComponent {
  ...
  ___updateSocketConfig = async (execArg = {}) => {
    ...
    try {
      ...
      // _.set(terminalService, "status", "OK");
      if (
  ...
  ___getWsHost = () => {
    ...
    // return `ws://192.168.2.91:55678`;
    // return `ws://127.0.0.1:55680`;
  };
  ...
  ___getQueryStrForSocket = () => {
    ...
    // return `?token=ee06bffb029c4f4299316b09ac78fd7b`;
  };
