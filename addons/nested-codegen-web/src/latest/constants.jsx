import Active4D from "./themes/editor/Active4D.json";
import All_Hallows_Eve from "./themes/editor/All Hallows Eve.json";
import Amy from "./themes/editor/Amy.json";
import Birds_of_Paradise from "./themes/editor/Birds of Paradise.json";
import Blackboard from "./themes/editor/Blackboard.json";
import Brilliance_Black from "./themes/editor/Brilliance Black.json";
import Brilliance_Dull from "./themes/editor/Brilliance Dull.json";
import Chrome_DevTools from "./themes/editor/Chrome DevTools.json";
import Clouds_Midnight from "./themes/editor/Clouds Midnight.json";
import Clouds from "./themes/editor/Clouds.json";
import Cobalt from "./themes/editor/Cobalt.json";
import Dawn from "./themes/editor/Dawn.json";
import Dominion_Day from "./themes/editor/Dominion Day.json";
import Dracula from "./themes/editor/Dracula.json";
import Dreamweaver from "./themes/editor/Dreamweaver.json";
import Eiffel from "./themes/editor/Eiffel.json";
import Espresso_Libre from "./themes/editor/Espresso Libre.json";
import GitHub from "./themes/editor/GitHub.json";
import IDLE from "./themes/editor/IDLE.json";
import Katzenmilch from "./themes/editor/Katzenmilch.json";
import Kuroir_Theme from "./themes/editor/Kuroir Theme.json";
import LAZY from "./themes/editor/LAZY.json";
import MagicWB_Amiga from "./themes/editor/MagicWB (Amiga).json";
import Merbivore_Soft from "./themes/editor/Merbivore Soft.json";
import Merbivore from "./themes/editor/Merbivore.json";
import Monokai_Bright from "./themes/editor/Monokai Bright.json";
import Monokai from "./themes/editor/Monokai.json";
import Night_Owl from "./themes/editor/Night Owl.json";
import Oceanic_Next from "./themes/editor/Oceanic Next.json";
import Pastels_on_Dark from "./themes/editor/Pastels on Dark.json";
import Slush_and_Poppies from "./themes/editor/Slush and Poppies.json";
import Solarized_dark from "./themes/editor/Solarized-dark.json";
import Solarized_light from "./themes/editor/Solarized-light.json";
import SpaceCadet from "./themes/editor/SpaceCadet.json";
import Sunburst from "./themes/editor/Sunburst.json";
import Textmate_Mac_Classic from "./themes/editor/Textmate (Mac Classic).json";
import Tomorrow_Night_Blue from "./themes/editor/Tomorrow-Night-Blue.json";
import Tomorrow_Night_Bright from "./themes/editor/Tomorrow-Night-Bright.json";
import Tomorrow_Night_Eighties from "./themes/editor/Tomorrow-Night-Eighties.json";
import Tomorrow_Night from "./themes/editor/Tomorrow-Night.json";
import Tomorrow from "./themes/editor/Tomorrow.json";
import Twilight from "./themes/editor/Twilight.json";
import Upstream_Sunburst from "./themes/editor/Upstream Sunburst.json";
import Vibrant_Ink from "./themes/editor/Vibrant Ink.json";
import Xcode_default from "./themes/editor/Xcode_default.json";
import Zenburnesque from "./themes/editor/Zenburnesque.json";
import iPlastic from "./themes/editor/iPlastic.json";
import idleFingers from "./themes/editor/idleFingers.json";
import krTheme from "./themes/editor/krTheme.json";
import monoindustrial from "./themes/editor/monoindustrial.json";
import themelist from "./themes/editor/themelist.json";
let COMMON_SIZE = 25;
