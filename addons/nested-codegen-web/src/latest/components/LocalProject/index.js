...
export default observer((props) => {
  ...
  return (
    <Card style={props.style} className="local-project-logic-box">
      <h2 className="bar-label">{t("My Local Folders")}</h2>
      <LocalProjectSelect value={{}} noSelect={true}></LocalProjectSelect>
    </Card>
  );
});
