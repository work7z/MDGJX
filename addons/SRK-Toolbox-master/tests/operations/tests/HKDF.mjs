...
TestRegister.addTests([
    {
        ...
        "recipeConfig": [
            ...
            },
            {
                "op": "派生HKDF密钥",
                "args": [
                    {"option": "十六进制", "string": "000102030405060708090a0b0c"},
                    {"option": "十六进制", "string": "f0f1f2f3f4f5f6f7f8f9"},
                    "SHA256", "加盐", 42,
                ],
            },
        ],
    },
    {
        ...
        "recipeConfig": [
            ...
            },
            {
                "op": "派生HKDF密钥",
                "args": [
                    {"option": "十六进制", "string": "606162636465666768696a6b6c6d6e6f707172737475767778797a7b7c7d7e7f808182838485868788898a8b8c8d8e8f909192939495969798999a9b9c9d9e9fa0a1a2a3a4a5a6a7a8a9aaabacadaeaf"},
    ...
    },
    {
        ...
        "input": "0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b",
        "expectedOutput": "L的值太大（对于SHA256的最大长度是8160）",
        "recipeConfig": [
            {
                "op": "十六进制转字符",
                "args": ["无"],
